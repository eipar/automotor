...
{
	int i;
	uint8_t array[MLin_Data] = {0,1,0,1,0,1,0,1};
	LIN_frame frame_tx,frame_rx;
	...
	PinCfg_UART0.Pinnum = 2;      //Pin 0 para TXD0
...
uint8_t LIN_Receive(LIN_frame *frame){
	...
	else return(0); //Retorno error en caso de fallar Sync Breack
